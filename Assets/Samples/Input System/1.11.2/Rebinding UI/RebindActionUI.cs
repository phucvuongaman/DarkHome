...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        /// </summary>
        public TMPro.TextMeshPro actionLabel
        {
            get => m_ActionLabel;
            set
            {
        ...
        /// </summary>
        public TMPro.TextMeshPro bindingText
        {
            get => m_BindingText;
            set
            {
        ...
        public TMPro.TextMeshPro rebindPrompt
        {
            get => m_RebindText;
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            .WithControlsExcluding("<Mouse>") // Bỏ click chuột đi
            // .WithCancelingThrough("<Keyboard>/escape") /// Tôi vừa thêm để thoát binding khi ấn Esc
                .OnCancel(
                    operation =>
                    {
        ...
        private bool CheckDuplicateBindings(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            foreach (InputBinding binding in action.actionMap.bindings)
            {
                ...
                {
                    Debug.Log("Dulicate binding found: " + newBinding.effectivePath);
                    return true;
                }
            }
        ...
        [SerializeField]
        private TMPro.TextMeshPro m_ActionLabel;

        [Tooltip("Text label that will receive the current, formatted binding string.")]
        [SerializeField]
        private TMPro.TextMeshPro m_BindingText;
        ...
        [SerializeField]
        private TMPro.TextMeshPro m_RebindText;

        [Tooltip("Optional bool field which allows you to OVERRIDE the action label with your own tet")]
        public bool m_OverRideActionLable;

        [Tooltip("Wthat text should displayed for the action label?")]
        [SerializeField]
